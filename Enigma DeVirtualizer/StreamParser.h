...
public:
	...
	bool ParseStream(BYTE* Stream, struct Node* Dest, struct PtrNode* PtrDest, lModInfo mInf);
	bool ExistNodePtr(PtrNode NodePtr);
	bool ExistNode(Node NodePtr);
